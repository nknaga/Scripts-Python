...
class Individual(object):
    ...
    def mutate(self):
        i1 = random.randint(0, len(self.pieces)-1)
        i2 = random.randint(0, len(self.pieces)-1)
        self.pieces[i1], self.pieces[i2] = self.pieces[i2], self.pieces[i1]
    ...
    def to_image(self):
        ...
        res = image_helpers.assemble_image(pieces, self.rows, self.columns)
        return res
